...
//                            ProjectRowView(infoOverLayInfo: infoOverLayInfo, showInfo: $showInfo, title: data.title, question: data.title, info: data.description)
//                        }
//                    }
//                }
//            }
...
//        DuringProject(infoOverLayInfo: OverLayInfo(), showButtons: .constant(false))
//        DuringProject(infoOverLayInfo: OverLayInfo(), showButtons: .constant(false))
//            .colorScheme(.dark)
//    }
//}
