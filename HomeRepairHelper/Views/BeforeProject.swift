...
struct BeforeProject: View {
    ...
    var body: some View {
        ...
        .onAppear {
            telemtryData.sendScreen(screen: "BeforeProjectView")
        }
    }
}
...
var beforeProjectData = [
    BeforeProjectData(trackingID: 0, title: "Have you researched the project?", description: "We suggest you go to your local retailers and/or local homebuilder’s association and ask questions, so you have a better understanding of what it will take to do your project.  This is also a good time to pick out the items you want (i.e., style of granite, exact cabinets you want, stove, color of paint, etc.)"),
